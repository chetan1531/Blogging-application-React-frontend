...
import com.Project1.blog.services.FileService;
...
public class PostController {
	...
	public ResponseEntity<List<PostDto>> searchPostByTitle(@PathVariable("keywords") String keywords){
		...
		List<PostDto> psDtos=this.postService.searchPosts(keywords);
		return new ResponseEntity<List<PostDto>>(psDtos,HttpStatus.OK);
	}
